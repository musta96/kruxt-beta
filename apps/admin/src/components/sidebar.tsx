...
const navigation: NavGroup[] = [
  ...
  },
  {
    title: "Operations",
    items: [
      { label: "Waivers", href: "/waivers", icon: "file-text" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Support", href: "/support", icon: "message-circle" },
...
export function Sidebar({ collapsed, onToggle }: SidebarProps) {
  ...
  return (
    <aside
      className={cn(
        "fixed inset-y-0 left-0 z-30 flex flex-col border-r border-border bg-kruxt-surface transition-all duration-200",
        collapsed ? "w-16" : "w-60"
      )}
    >
      {/* Logo area */}
                  ...
                  <li key={item.href}>
                    <Link
                      ...
                      className={cn(
                        ...
                        active
                          ? "bg-kruxt-accent/10 text-kruxt-accent"
                    ...
                    >
                      <span
                        className={cn(
                          "flex-shrink-0",
                          active ? "text-kruxt-accent" : "text-muted-foreground group-hover:text-foreground"
                        )}
                      >
                        {iconMap[item.icon]}
                      </span>
