...
export function ProgressBar({ value }: { value: number }) {
  return (
    <div className="progress-track w-full" role="progressbar" aria-valuenow={value} aria-valuemin={0} aria-valuemax={100}>
...
export function SectionTitle({ children }: { children: React.ReactNode }) {
  return (
    <h1 className="text-3xl font-display font-black text-foreground leading-tight">{children}</h1>
  );
}
...
export function ErrorBanner({ message, onRetry }: { message: string; onRetry?: () => void }) {
  return (
    <div className="panel border-destructive/40 bg-destructive/10 p-4 flex flex-col gap-2" role="alert">
